...
@section('content')
    <div class="bg-white p-8 rounded-xl shadow">
        ...
        <h1 class="text-3xl font-bold mb-6">➕ แก้ไขห้องพัก</h1>
        ...
        <form action="/update-roompages/{{ $room->id }}" method="POST">
            @csrf
            @method('PUT')

            <div class="mb-4">
                <label class="block font-medium mb-1">เลขห้อง</label>
                <input type="text" name="name_room" value="{{ old('name_room', $room->name_room) }}"
